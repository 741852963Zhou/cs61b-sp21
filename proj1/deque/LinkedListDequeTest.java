...
public class LinkedListDequeTest {
    ...
    public void iteratorTest(){
        ...
        lld1.addLast(2);
        lld1.addLast(3);
        LinkedListDeque<Integer> expected = new LinkedListDeque<>();
        expected.addFirst(1);
        expected.addLast(2);
        expected.addLast(3);
        ...
        int index = 0;
        for(int item: lld1){
            assertEquals(item,(int) expected.get(index));
            index++;
        }
    ...
    public void equalsTest(){
        ...
        expected.addLast(2);
        expected.addLast(3);
        assertEquals(expected,lld1);

        LinkedListDeque<Integer> lld2 = new LinkedListDeque<>();
        lld2.addFirst(1);
        lld2.addLast(2);
        lld2.addLast(3);
        LinkedListDeque<Integer> expected2 = new LinkedListDeque<>();
        expected2.addFirst(1);
        expected2.addLast(2);
        assertNotEquals(expected2,lld2);

        LinkedListDeque<Integer> lld3 = new LinkedListDeque<>();
        lld3.addFirst(1);
        lld3.addLast(2);
        lld3.addLast(3);
        LinkedListDeque<Integer> expected3 = new LinkedListDeque<>();
        expected3.addFirst(1);
        expected3.addLast(2);
        expected3.addLast(2);
        assertNotEquals(expected3,lld3);
    }
    @Test
